...
class PostTableViewCell: UITableViewCell {
    ...
    private let photosCVC = PhotosCollectionViewCell()
        
        private lazy var collectionButton: UIButton = {
            let collectionButton = UIButton()
            collectionButton.translatesAutoresizingMaskIntoConstraints = false
            collectionButton.setTitle("кнопка", for: .normal)
            collectionButton.setTitleColor(.orange, for: .normal)
        ...
        private func loyut() {
            ...
            [authorText, postImage, discriptionText, likeText, viewsText, collectionButton, photosCVC].forEach {
                contentView.addSubview($0)}
            
            NSLayoutConstraint.activate([
                
                photosCVC.topAnchor.constraint(equalTo: safeAreaLayoutGuide.topAnchor, constant: 20),
                photosCVC.leadingAnchor.constraint(equalTo: leadingAnchor, constant: 16),
                photosCVC.trailingAnchor.constraint(equalTo: trailingAnchor, constant: -16),
                
                authorText.topAnchor.constraint(equalTo: contentView.topAnchor, constant: 50),
    //            authorText.topAnchor.constraint(equalTo: contentView.topAnchor, constant: 16), // было
                ...
                collectionButton.topAnchor.constraint(equalTo: authorText.bottomAnchor, constant: 15),
                collectionButton.trailingAnchor.constraint(equalTo: safeAreaLayoutGuide.trailingAnchor, constant: -16),
            ])
        }
